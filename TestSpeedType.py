...
class Ui_PagesWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("E:\qttt\TestSpeedType\\logo.png" ), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        MainWindow.setWindowIcon(icon)
        MainWindow.setStyleSheet("background: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:0, stop:0 #30E8BF, stop:1 #FF8235);\n"
"border-radius: 10px;")
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.sidebar = QtWidgets.QFrame(self.centralwidget)
        self.sidebar.setGeometry(QtCore.QRect(-1, 0, 130, 500))
        self.sidebar.setStyleSheet("background:#a2ab58;\n"
"border-radius: 10px;\n"
"")
...
"}")
        ...
        self.label.setText("")
        self.label.setPixmap(QtGui.QPixmap("E:\qttt\TestSpeedType\\sidebar.png"))
...
"border-radius: 5px;")
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("E:\qttt\TestSpeedType\\restart.png" ), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"border-radius: 5px;")
        ...
        self.label_10.setPixmap(QtGui.QPixmap("E:\qttt\TestSpeedType\\key-img.png"))
...
###############
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("E:\qttt\TestSpeedType\\close.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"")
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("E:\qttt\TestSpeedType\\minimize.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
